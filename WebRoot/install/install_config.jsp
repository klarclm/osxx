...
<%@page import="net.osxx.CommonAttributes"%>
<%@page import="net.osxx.util.JsonUtils"%>
...
<%
	...
	if (status.equals("success")) {
		try {
			...
			Element siteUrlElement = (Element) document.selectSingleNode("/osxx/setting[@name='siteUrl']");
			Element logoElement = (Element) document.selectSingleNode("/osxx/setting[@name='logo']");
			Element defaultLargeProductImageElement = (Element) document.selectSingleNode("/osxx/setting[@name='defaultLargeProductImage']");
			Element defaultMediumProductImageElement = (Element) document.selectSingleNode("/osxx/setting[@name='defaultMediumProductImage']");
			Element defaultThumbnailProductImageElement = (Element) document.selectSingleNode("/osxx/setting[@name='defaultThumbnailProductImage']");
			String siteUrl;
