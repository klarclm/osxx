...
<%
	...
	boolean isShopxxXmlCanWrite = isCanWrite(rootPath + "/WEB-INF/classes/osxx.xml");
	boolean isShopxxPropertiesWrite = isCanWrite(rootPath + "/WEB-INF/classes/osxx.properties");
...
<body>
	...
	<div class="body">
		...
		<div class="bodyRight">
			...
			<table>
				...
				<tr>
					<td>
						/WEB-INF/classes/osxx.properties
					</td>
					<td>
						可写
					</td>
	...
	<div class="footer">
		<p class="copyright">Copyright © 2005-2013 klarclm.com All Rights Reserved.</p>
	</div>
</body>
</html>