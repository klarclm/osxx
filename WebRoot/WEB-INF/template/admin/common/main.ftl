	...
	<table class="main">
		<tr>
			...
			<th>
				...
				<div class="link">
					<a href="http://www.klarclm.com" target="_blank">${message("admin.main.official")}</a>|
					<a href="http://bbs.klarclm.com" target="_blank">${message("admin.main.bbs")}</a>|
					<a href="http://www.klarclm.com/about.html" target="_blank">${message("admin.main.about")}</a>
				</div>
				<div class="link">
