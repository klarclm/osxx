...
<%@page import="net.osxx.Setting"%>
<%@page import="net.osxx.util.SettingUtils"%>
<%@page import="net.osxx.util.SpringUtils"%>
<%@page import="net.osxx.Setting.CaptchaType"%>
<%@page import="net.osxx.Setting.AccountLockType"%>
<%@page import="net.osxx.service.RSAService"%>
		...
		<div class="login">
			<form id="loginForm" action="login.jsp" method="post">
				...
				<div class="link">
					...
					<a href="http://www.klarclm.com"><%=SpringUtils.getMessage("admin.login.official")%></a> |
					<a href="http://bbs.klarclm.com"><%=SpringUtils.getMessage("admin.login.bbs")%></a> |
					<a href="http://www.klarclm.com/about.html"><%=SpringUtils.getMessage("admin.login.about")%></a> |
					<a href="http://www.klarclm.com/contact.html"><%=SpringUtils.getMessage("admin.login.contact")%></a> |
					<a href="http://www.klarclm.com/license.html"><%=SpringUtils.getMessage("admin.login.license")%></a>
				</div>
			</form>
		</div>
	<%} else {%>
