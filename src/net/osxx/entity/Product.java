...
import net.osxx.BigDecimalNumericFieldBridge;
...
public class Product extends BaseEntity {
	...
	static {
		try {
			...
			org.dom4j.Document document = new SAXReader().read(osxxXmlFile);
			org.dom4j.Element element = (org.dom4j.Element) document.selectSingleNode("/osxx/template[@id='productContent']");
