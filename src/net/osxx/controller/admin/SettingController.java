...
import net.osxx.Setting.ConsultationAuthority;
import net.osxx.Setting.ReviewAuthority;
import net.osxx.Setting.RoundType;
import net.osxx.Setting.StockAllocationTime;
import net.osxx.Setting.WatermarkPosition;
import net.osxx.service.CacheService;
import net.osxx.service.FileService;
