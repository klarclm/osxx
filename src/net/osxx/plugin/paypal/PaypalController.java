 ...
 */
package net.osxx.plugin.paypal;
...
import net.osxx.controller.admin.BaseController;
import net.osxx.entity.PluginConfig;
import net.osxx.plugin.PaymentPlugin;
import net.osxx.plugin.PaymentPlugin.FeeType;
import net.osxx.plugin.paypal.PaypalPlugin.Currency;
import net.osxx.service.PluginConfigService;
...
public class PaypalController extends BaseController {
	...
	public String setting(ModelMap model) {
		...
		return "/net/osxx/plugin/paypal/setting";
	}
